  ...
  <nav className="w-full bg-card dark:bg-darkCard shadow-md px-6 py-2 flex items-center justify-between">
    ...
    <div className="flex items-center gap-4 relative">
      ...
      <div className="relative group">
        ...
        {/* Dropdown */}
        <div className="absolute right-0 mt-2 w-48 bg-card dark:bg-darkCard shadow-lg rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 z-50">
          <div className="p-4 flex flex-col gap-2">
            <span className="font-medium text-textPrimary dark:text-darkTextPrimary">John Doe</span>
            <span className="text-sm text-textSecondary dark:text-darkTextSecondary">john.doe@example.com</span>
